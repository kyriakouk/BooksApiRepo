...
public class Item {
	...
	public String toString() {
		return "Item [kind=" + kind + ", id=" + id + ", title=" + title + ", access=" + access + ", updated=" + updated
				+ ", created=" + created + ", volumeCount=" + volumeCount + ", volumesLastUpdated=" + volumesLastUpdated
