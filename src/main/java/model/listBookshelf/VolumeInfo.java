...
public class VolumeInfo {
	...
	public String toString() {
		return "VolumeInfo [title=" + title + ", authors=" + authors + ", publisher=" + publisher + ", publishedDate="
				...
				+ ", readingModes=" + readingModes + ", pageCount=" + pageCount + ", printType=" + printType
				+ ", categories=" + categories + ", averageRating=" + averageRating + ", ratingsCount=" + ratingsCount
				+ ", maturityRating=" + maturityRating + ", allowAnonLogging=" + allowAnonLogging + ", contentVersion="
				+ contentVersion + ", panelizationSummary=" + panelizationSummary + ", imageLinks=" + imageLinks
				+ ", previewLink=" + previewLink + ", infoLink=" + infoLink + ", canonicalVolumeLink="
