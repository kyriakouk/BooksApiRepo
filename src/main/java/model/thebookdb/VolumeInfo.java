...
public class VolumeInfo {
	...
	public String toString() {
		return "VolumeInfo [title=" + title + ", authors=" + authors + ", publisher=" + publisher + ", publishedDate="
				...
				+ ", categories=" + categories + ", maturityRating=" + maturityRating + ", allowAnonLogging="
				...
				+ ", subtitle=" + subtitle + ", averageRating=" + averageRating + ", ratingsCount=" + ratingsCount
        ...
        /*public String toString() {
            ...
            for (String search : searchHistory) {
                sb.append(i++).append(". ").append(search).append("\n");
            }
            return sb.toString();
        }
    }*/
